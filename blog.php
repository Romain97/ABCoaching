...
<html lang="fr">
  ...
  <head>
    ...
    ?>
		...
		<link type="text/css" rel="stylesheet" href="./css/style_blog.css">
    ...
    <div class="blog_section2">
      <article>
        ...
        Curabitur id massa vitae ipsum tristique pellentesque et ut ipsum. Donec tempor imperdiet lectus, nec aliquam elit venenatis eget. Suspendisse quis orci lectus. Sed volutpat sapien eu felis pulvinar iaculis. Suspendisse in metus cursus, tempor dui et, fermentum odio. Pellentesque non placerat mauris. Integer vel aliquet lacus. Ut ullamcorper, leo sed venenatis sagittis, tortor arcu pretium arcu, sed ornare neque velit nec metus. Vivamus dignissim, dui sed finibus fringilla, turpis nulla dictum augue, ultricies tempor nisl diam eu purus. Suspendisse gravida dui a vestibulum tempus. In maximus aliquet ipsum, non ornare ex vulputate nec. Mauris rutrum sapien vitae tellus eleifend, quis tincidunt ex tempus. In est massa, imperdiet in pretium eget, facilisis eleifend tellus. Donec luctus ex vel dui varius, ac sodales massa sodales. Aenean et ullamcorper dolor. Nulla volutpat posuere eros. </p>
      </article>
      <article>
